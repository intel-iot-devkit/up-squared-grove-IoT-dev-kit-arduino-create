        ...
        else
        {
            ...
            else
            {
                ...
                do
                {
                    ...
                    {
                        //get the input from the rotary angle sensor on pin A0
                        angle = analogRead(512);
                        sprintf_s(msgText, sizeof(msgText), "{\"deviceId\":\"myFirstDevice\",\"angle\":%.2f}", angle);
                        ...
                        else
                        {
                            ...
                            (void)sprintf_s(propText, sizeof(propText), angle > 512 ? "true" : "false");
                            if (Map_AddOrUpdate(propMap, "Alert", propText) != MAP_OK)
                            {
